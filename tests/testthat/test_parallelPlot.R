describe("options", {
    ...
    describe("data", {
        ...
        it("should refuse unvalid value and throw an error", {
            expect_error(
    ...
    describe("categorical", {
        ...
        it("should fix unvalid type and print a message", {
            categorical <- 1
            expect_message(
        ...
        it("should fix unvalid elements and print a message", {
        ...
        it("should accept vector type for elements (by coercing to list)", {
            ...
            fixed <- sapply(categorical, function(cat) ifelse(is.null(cat), list(NULL), list(as.list(cat))))
            expect_equal(
                parallelPlot(mtcars, categorical = categorical)$x$categorical, 
                fixed
            )
        })
        it("should fix unvalid length and print a message", {
            categorical <- list()
            expect_message(
                out <- parallelPlot(mtcars, categorical = categorical), 
    ...
    describe("cutoffs", {
        ...
        it("should fix unvalid continuous type and print a message", {
        ...
        it("should fix unvalid categorical type and print a message", {
    ...
    describe("refRowIndex", {
        ...
        it("should fix unvalid value and print a message", {
            refRowIndex <- 0
            expect_message(
                out <- parallelPlot(iris, refRowIndex = refRowIndex), 
